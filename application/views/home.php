...
<html lang="en">
  ...
  <body class="bg-primary">
    <div class="w-100 bg-primary pb-5">
      <div
        class="container py-5 px-4 d-flex flex-column flex-md-row align-items-center"
      >
        <div class="d-flex justify-content-lg-start justify-content-center">
          <img
            src="./asset/img/Logo-smpn-2-sidoharjo.png"
            alt="Logo_SMPN_2_Sidoharjo"
            class="logo mb-2"
          />
        </div>
      ...
      <div id="datainput" class="d-flex align-items-center flex-column m-2 mb-4 hidden">
        ...
        <input
          ...
          name=""
          id="Induk"
          class="form-control-lg input-nis"
        />
      </div>
          ...
          <div class="card card-nis">
            <div class="card-body">
              ...
              <p class="fs-6">
                ...
                Nomor Pokok Sekolah Nasional 20312931 Kabupaten Sragen Provinsi
                Jawa Tengah, menerangkan dengan ini sesungguhnya bahwa:
              </p>
